 ...
 * @see User
 */
@Service("when2work.UserService")
@Validated
@EntityService(entityClass = User.class, serviceId = "when2work")
public class UserServiceImpl implements UserService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service when2work for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service when2work for table User to {} format", options.getExportType());
