...
public interface EmployeeService {
     ...
     *
     * @param employeeIdInstance The id of the Employee to get; value cannot be null.
     * @return Employee associated with the given employeeIdInstance.
	 * @throws EntityNotFoundException If no Employee is found.
     */
    Employee getById(Integer employeeIdInstance);
     ...
     * @return Employee associated with the given employeeIdInstance.
     */
    Employee findById(Integer employeeIdInstance);
     ...
     *
     * @param employeeIdInstances The id's of the Employee to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Employees associated with the given employeeIdInstances.
     */
    List<Employee> findByMultipleIds(List<Integer> employeeIdInstances, boolean orderedReturn);
     ...
     * This method overrides the input field values using Server side or database managed properties defined on Employee if any.
     *
     * @param employeeIdInstance The id of the Employee to be deleted; value cannot be null.
     * @param employeePatch The partial data of Employee which is supposed to be updated; value cannot be null.
     * @return The updated Employee.
     * @throws EntityNotFoundException if no Employee is found with given input.
     */
    Employee partialUpdate(Integer employeeIdInstance, Map<String, Object> employeePatch);
     ...
     */
    Employee delete(Integer employeeIdInstance);
    ...
    /*
     * Returns the associated employeePhones for given Employee id.
     *
     * @param employeeId value of employeeId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated EmployeePhone instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<EmployeePhone> findAssociatedEmployeePhones(Integer employeeId, Pageable pageable);

    /*
     * Returns the associated employeeSkills for given Employee id.
     *
     * @param employeeId value of employeeId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<EmployeeSkill> findAssociatedEmployeeSkills(Integer employeeId, Pageable pageable);

    /*
     * Returns the associated scheduledEmployeesForChangedBy for given Employee id.
     *
     * @param employeeId value of employeeId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<ScheduledEmployee> findAssociatedScheduledEmployeesForChangedBy(Integer employeeId, Pageable pageable);

    /*
     * Returns the associated scheduledEmployeesForEmployeeId for given Employee id.
     *
     * @param employeeId value of employeeId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated ScheduledEmployee instances.
     ...
     * @see Page
     */
    Page<ScheduledEmployee> findAssociatedScheduledEmployeesForEmployeeId(Integer employeeId, Pageable pageable);
