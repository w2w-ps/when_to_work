package com.wavemaker.when_to_work.getPositionGroup.service;


import com.wavemaker.when_to_work.getPositionGroup.model.*;
import com.wavemaker.when_to_work.getPositionGroup.model.RootResponse;
...
public interface GetPositionGroupService {
   ...
   * @return RootResponse
   */
  @RequestLine("GET /position-groups?companyId={companyId}&status={status}")
  @Headers({
